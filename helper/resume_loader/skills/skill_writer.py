...
def loadall():
    ...
    load("C++", "https://cdn.cdnlogo.com/logos/c/76/c.svg")
    ...
    load("Flask", "https://cdn.jsdelivr.net/gh/yichenchong/personal-website/helper/resume_loader/skills/img/flask-original.png")
    load("Pytest", "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/pytest/pytest-original.svg")
    load("Swagger", "https://cdn.jsdelivr.net/gh/yichenchong/personal-website/helper/resume_loader/skills/img/swagger_logo.svg")
    ...
    load("Microsoft Office", "https://cdn.cdnlogo.com/logos/o/96/office.svg")
